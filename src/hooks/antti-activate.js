...
function needsModelSetup() {
  const configPath = path.join(require("node:os").homedir(), ".abyss", "models.json");
  try {
...
No model configuration found at ~/.abyss/models.json (or it is outdated).
...
6. Save confirmed models to ~/.abyss/models.json in this format:
